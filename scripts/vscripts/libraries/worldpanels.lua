...
--[[
  ...
  -Ensure that you have the randyarena_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the randyarena_worldpanels.js in your panorama content scripts folder.
  -Ensure that randyarena_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/randyarena_worldpanels.xml" />
