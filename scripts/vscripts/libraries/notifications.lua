...
--[[
  ...
  -Ensure that you have the randyarena_notifications.xml, randyarena_notifications.js, and randyarena_notifications.css files in your panorama content folder.
  -Ensure that randyarena_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/randyarena_notifications.xml" />
