...
--[[
  ...
  -Ensure that you have the randyarena_attachments.xml, randyarena_attachments.js, and randyarena_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that randyarena_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/randyarena_attachments.xml" />
