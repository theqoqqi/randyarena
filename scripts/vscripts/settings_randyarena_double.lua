...
PARTICLES_FOLDER = 'particles/maps/double';

DEBUG_ABILITY_CHESTS = false and IsInToolsMode();
...
if DEBUG_ABILITY_CHEST then
	FORCE_ABILITY_COURIER = 'sniper';
	FORCE_CHEST_ABILITY = 'sniper_assassinate';
end
...
if FAST_START then
	...
	FORCE_PICKED_HERO = 'npc_dota_hero_lina';
else
	SKIP_TEAM_SETUP = IsInToolsMode();
	FORCE_PICKED_HERO = nil;
end

HEROES_TO_PRECACHE = IsInToolsMode() and 1 or 15;
CLOSE_TO_VICTORY_THRESHOLD = 5;
ABILITY_CHEST_THINKING_TIME = IsInToolsMode() and 3 or 15;
...
GXPM_SETTINGS = {
    global = { goldPerTick = 5, xpPerTick = 5, tickRate = 0.5 },
    circle = { goldPerTick = 1, xpPerTick = 2, tickRate = 0.1, radius = 1000 },
};

RUNE_SETTINGS = {
	[1] = { count = 5, spawnTime = 120, baseGold = 240, goldPerMinute = 24 },
	...
	[9] = { count = 4, spawnTime = 120, baseGold = 270, goldPerMinute = 27 },
	[10]= { count = 5, spawnTime = 120, baseGold = 240, goldPerMinute = 24 },
};

ABILITY_CHEST_SETTINGS = {   -- ultimative				-- generic abilities
	[1] = { level_chances = { [3] = { 25, 25, 25, 25, }, [4] = { 20, 20, 20, 20, 20, }, } },
	[2] = { level_chances = { [3] = { 90, 10, 0,  0,  }, [4] = { 80, 15, 5,  0,  0,  }, } },
	[3] = { level_chances = { [3] = { 85, 10, 5,  0,  }, [4] = { 70, 20, 5,  5,  0,  }, } },
	[4] = { level_chances = { [3] = { 80, 15, 5,  0,  }, [4] = { 60, 25, 10, 5,  0,  }, } },
	[5] = { level_chances = { [3] = { 75, 15, 10, 0,  }, [4] = { 50, 25, 15, 5,  5,  }, } },
	[6] = { level_chances = { [3] = { 70, 20, 10, 0,  }, [4] = { 40, 30, 20, 5,  5,  }, } },
	[7] = { level_chances = { [3] = { 65, 25, 10, 0,  }, [4] = { 30, 30, 25, 10, 5,  }, } },
	[8] = { level_chances = { [3] = { 60, 25, 10, 5,  }, [4] = { 20, 35, 25, 10, 10, }, } },
	[9] = { level_chances = { [3] = { 55, 25, 15, 5,  }, [4] = { 10, 35, 30, 15, 10, }, } },
	[10]= { level_chances = { [3] = { 50, 30, 15, 5,  }, [4] = {  0, 35, 30, 20, 15, }, } },
};
...
MATCH_SETTINGS = {
	...
	[9] = { killsToWin = 30, matchDuration = 1801 },
	[10]= { killsToWin = 30, matchDuration = 1801 },
};
...
STRATEGY_TIME = 15;
SHOWCASE_TIME = 0;
PRE_GAME_TIME = IsInToolsMode() and 10 or 15;                    -- How long after people select their heroes should the horn blow and the game start?
...
STARTING_GOLD = 900;                     -- How much starting gold should we give to each player?
...
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_GOODGUYS] = IsInToolsMode() and 2 or 0;
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_BADGUYS]  = IsInToolsMode() and 2 or 0;
